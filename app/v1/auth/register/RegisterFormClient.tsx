    ...
    <div className="min-h-screen w-full flex bg-[#0e0e0e]">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full px-12 xl:px-16 py-12">
          ...
          <div>
            <h1 className="font-orbitron font-black uppercase leading-[0.88] tracking-tight mb-6">
              <span className="block text-white neon-red text-[3rem] xl:text-[4.2rem]">
                Become a
              </span>
              <span className="block text-[#ffb4ab] italic text-[3.5rem] xl:text-[5.5rem] [text-shadow:0_0_40px_rgba(255,180,171,0.5)]">
                Champion
              </span>
            </h1>
            ...
            <div className="flex gap-12 mt-10">
              {[
                ...
                <div key={s.label}>
                  <p className="font-orbitron font-black text-3xl text-white [text-shadow:0_0_20px_rgba(255,180,171,0.4)]">
                    {s.value}
                  </p>
          ...
          <p className="font-orbitron font-black text-[6rem] xl:text-[8rem] text-white/[0.04] leading-none select-none tracking-tighter">
            A
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 overflow-y-auto relative">
        ...
        <div className="w-full max-w-[500px] mt-16">
          <div className="bg-white/[0.03] backdrop-blur-[20px] border border-crimson/30 rounded-2xl p-8 xl:p-10 shadow-[0_0_60px_rgba(255,46,46,0.08)]">
            <div className="text-center mb-8">
              <h2 className="font-orbitron font-black text-2xl xl:text-3xl text-[#ffb4ab] uppercase tracking-tight">
                Titan Arena
              </h2>
              <div className="w-16 h-0.5 bg-crimson mx-auto mt-3 shadow-[0_0_8px_rgba(255,46,46,0.6)]" />
            </div>
